export function MetadataForm({
 name, description, color, onNameChange, onDescriptionChange, onColorChange
}: {
    ...
    return (
      <div className="geojson-meta">
        ...
        <div className="geojson-color-row">
          ...
          <input id="layer-color" type="color" value={color} onChange={(e) => onColorChange(e.target.value)} />
        </div>
      </div>
    );
}
